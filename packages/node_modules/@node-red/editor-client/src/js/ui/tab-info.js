...
RED.sidebar.info = (function() {
    ...
    function refresh(node) {
        ...
        // 新增：处理当前站点
        if (node && (node.id === "__currentsite__" || node.id === "__currentsite_url__")) {
            propertiesPanelHeaderIcon.empty();
            propertiesPanelHeaderLabel.text(RED._("sidebar.info.currentSite"));
            ...
            var siteUrl = window.location.origin + '/nodered';
            var propRow = $('<tr class="red-ui-help-info-row"><td>'+RED._("sidebar.info.currentSiteDesc")+'</td><td></td></tr>').appendTo(tableBody);
            var urlCell = $(propRow.children()[1]);
            urlCell.text(siteUrl);
            return;
        }
