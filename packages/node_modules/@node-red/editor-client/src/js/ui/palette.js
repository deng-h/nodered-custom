...
RED.palette = (function() {
    ...
    function init() {
        ...
        try {
            ...
            // Set all categories as collapsed except 'common'
            if (!paletteState.collapsed) {
                paletteState.collapsed = [];
            }
            // Add all categories except 'common' to collapsed list
            coreCategories.forEach(function(category) {
                if (category !== '技能' && !paletteState.collapsed.includes(category)) {
                    paletteState.collapsed.push(category);
                }
            });
