...
#red-ui-workspace {
    ...
    .button {
        ...
        border-right: none;
        &:hover {
            background-color: var(--red-ui-workspace-button-background-active);
        }
        &:active, &.active {
    ...
    #red-ui-header-button-deploy {
        ...
        &.disabled {
            ...
            .red-ui-header-button-deploy-image {
                background-color: rgba(140, 16, 28, 0.38);
            }
        ...
        .red-ui-header-button-deploy-image {
            ...
            padding: 2px;
            margin-right: 10px;
            background-color: rgba(140, 16, 28, 1);
        }
    }
    ...
    // 急停按钮样式
    .red-ui-emergency-stop-button-group {
        display: inline-block;
        vertical-align: middle;
        margin-right: 10px;
        
        .red-ui-emergency-stop-button {
            background: var(--red-ui-workspace-button-background);
            color: var(--red-ui-tab-text-color-active);
            font-weight: bold;
            padding: 2px 12px;
            ...
            .red-ui-emergency-stop-button-content {
                display: flex;
                align-items: center;
                justify-content: center;
    ...
    ul.red-ui-menu-dropdown {
        ...
        li.red-ui-menu-divider {
            background: var(--red-ui-menuDivider);
        }
        li.disabled a {
