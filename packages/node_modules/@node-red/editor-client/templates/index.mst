...
<!-- Node-RED Playground Styles -->
<link rel="stylesheet" href="red/playground.css?v={{ cacheBuster }}">
{{#page.css}}
...
<!-- Node-RED Playground Scripts -->
<script src="red/playground.js?v={{ cacheBuster }}"></script>
{{# page.scripts }}
<script src="{{.}}"></script>
{{/ page.scripts }}
{{#sessionMessages}}
